...
```powershell
msiexec /i .\Installer\bin\Release\CodexBarWindows-0.2.1-win-x64.msi /qn
```
...
- Tags must look like `v0.2.1`.
- The release must include an MSI asset, for example `CodexBarWindows-0.2.1-win-x64.msi`.
