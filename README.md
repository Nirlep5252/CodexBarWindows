...
```powershell
msiexec /i .\Installer\bin\Release\CodexBarWindows-0.3.2-win-x64.msi /qn
```
...
- Tags must look like `v0.3.3`.
- The release must include an MSI asset, for example `CodexBarWindows-0.3.3-win-x64.msi`.
