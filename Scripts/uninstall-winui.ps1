# Removes the WinUI 3 shell. The counterpart of Scripts/uninstall.ps1.
#
# Only products named "CodexBar (WinUI 3)" and only the CodexBar.WinUI install folder and Run
# value are touched: an installed WinForms CodexBarWindows keeps its files, its Start menu entry
...
if (Test-Path -LiteralPath $runKeyPath) {
    # ShellIdentity.StartupRegistryValueName, NOT "CodexBarWindows".
